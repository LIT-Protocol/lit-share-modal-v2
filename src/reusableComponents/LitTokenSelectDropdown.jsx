...
const LitTokenSelectDropdown = ({ options, label, setOption, option, }) => {
  ...
  return (
    <div className={'lms-w-11/12 lms-z-20 lms-mx-auto lms-px-2'}>
      ...
      {!!selectIsOpen && (
        <div className={'lms-absolute lms-w-full lms-h-full lms-top-0 lms-left-0 lms-bg-brand-20 lms-p-6'}>
          ...
          <span className={'lms-w-full lms-h-16 lms-fixed lms-bottom-0 lms-left-0 lms-py-3lms-bg-brand-20'}>
            <LitBackButton label={'BACK TO TOKEN SELECT'}
                           backgroundColor={'lms-bg-brand-20'}
